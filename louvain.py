...
if __name__ == '__main__':
    Gs = nx.read_edgelist('./datasets/copen/index.mtx', nodetype=int, create_using=nx.DiGraph())
    G = load_graph('./datasets/p2p.txt')
    algorithm = Louvain(G)
    communities = algorithm.execute()
    with open('communities1.txt', 'w') as hello :
        ...
        #         if v in c:
        #             subG.add_edge(u, v)
        # print(nx.strongly_connected_components(subG))
        # print(123)
